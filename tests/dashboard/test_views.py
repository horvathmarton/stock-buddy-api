...
from src.dashboard.models import Strategy, UserStrategy
from src.lib.enums import Visibility
...
class TestPortfolioIndicators(TestCase):
    ...
    def test_roic_should_only_consider_invested_capital(self):
        ...
        self.assertEqual(round(response.data["largest_sector_exposure"], 4), 0.5405)
        self.assertEqual(round(response.data["largest_position_exposure"], 4), 0.5405)

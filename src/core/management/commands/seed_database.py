...
def seed_users():
    mhorvath = User.objects.create_user('mhorvath', 'mhorvath@stock-buddy.com', 'password', is_superuser=True, is_staff=True)
...
def seed_stocks():
    Stock.objects.bulk_create([
        ...
        Stock(ticker='PM', name='Philip Morris International', sector=Sector.CONSUMER_GOODS),
        Stock(ticker='BABA', name='Alibaba Group Holding Limited', sector=Sector.CONSUMER_SERVICES),
    ])
